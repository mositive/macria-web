      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5 sm:px-8">
          <a href="#" className="group flex items-center gap-2.5">
            <span className="relative flex size-9 items-center justify-center">
              ...
              <Image
                ...
                width={36}
                height={36}
                className="relative drop-shadow-[0_0_10px_rgba(31,107,240,0.6)]"
              />
            </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="#indir"
              className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-brand-600 to-brand-400 px-4 py-2 text-sm font-medium text-white shadow-lg shadow-brand-600/25 transition-shadow hover:shadow-brand-500/40"
            >
            ...
            <button
              ...
              aria-label="Menü"
              aria-expanded={open}
              className="ml-1 rounded-lg border border-line p-2 text-slate-300 md:hidden"
            >
          ...
          <div className="flex flex-col px-5 py-3">
            {nav.map((item) => (
              <a
                ...
                className="rounded-lg px-2 py-3 text-sm text-slate-300 transition-colors hover:bg-white/5 hover:text-white"
              >
                {item.label}
              </a>
            ))}
